...
class State(metaclass=Metaclass_State):
    ...
    def __init__(self, **kwargs):
        ...
        self.droneid = kwargs.get('droneid', int())
    ...
    @property
    def droneid(self):
        """Message field 'droneid'."""
        return self._droneid

    @droneid.setter
    def droneid(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'droneid' field must be of type 'int'"
            assert value >= 0 and value < 4294967296, \
                "The 'droneid' field must be an unsigned integer in [0, 4294967295]"
        self._droneid = value
